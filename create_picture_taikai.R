...
file1.name<-sprintf("../pic_csv/sensor_target.csv")
...
col <- c(cols[2], cols[3], cols[3]) # 線の色
#rain <- rainbow(12)
...
pdf(file="../picture/sensor_target.pdf", width=7, height=6, pointsize=27)
par(mgp=c(1.5,0.5,0), mar=c(2.4,3,0.5,1))
plot(d, sinkgc, xlim=c(1,50.0),ylim=c(0,1), pch=pch[1], col=col[1], lty=1, lwd=2, type="o", yaxp=c(0,1,10),
	xlab=x.label, ylab=y.label)
axis(side=1, at=c(2))
points(d, sinkph, pch=pch[2], col=col[2], type="o", lty=1, lwd=2)
